...
export class MonitorAgentService {
  ...
  private async notifySingleReview(
    ...
    try {
      ...
      logStructured("info", {
        ...
        property_id: this.config.propertyId,
        message:
          "Telegram notification skipped - owner telegram_id not available in this context",
        data: {
          platform: context.platform,
          platform_review_id: context.platformReviewId,
        },
  ...
  private async storeSingleReview(
    ...
    const reviewData = {
      ...
      public_response:
        this.state.analysisResult.public_response?.text || undefined,
      appeal_text: this.state.analysisResult.appeal?.text || undefined,
      appeal_confidence:
        this.state.analysisResult.appeal?.confidence || undefined,
